...
// for guide
	...
	public boolean activityEvent(@PathVariable String id) {
		return eventService.activityEvent(id);
	}
	
	@PutMapping("/{id}/disActivity")
	public boolean disactivityEvent(@PathVariable String id) {
		return eventService.disactivityEvent(id);
	}
